					...
					<div class="form_wrapper">
						...
						<div>
							<label for="initialdate1" class="singleline">Initial date:<span class="form_required" title="This field is required">*</span></label>
  							...
  							<input type="text" maxlength="60" name="company1" id="company1" class="singleline" value="<?php if (isset($company[0])) echo $company[0]; ?>" required="required"/>
							...
							<label for="initialdate2" class="singleline">Initial date:</label>
  							...
  							<input type="text" maxlength="60" name="company2" id="company2" class="singleline" value="<?php if (isset($company[1])) echo $company[1]; ?>" />
							...
							<label for="initialdate3" class="singleline">Initial date:</label>
  							...
  							<input type="text" maxlength="60" name="company3" id="company" class="singleline" value="<?php if (isset($company[2])) echo $company[2]; ?>" />
